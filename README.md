...
bruteForce.setMinLength(1); // Generates only codes with a minimum amount of 1 character.
bruteForce.setMax   Length(16); // Generates only codes with a maximum amount of 16 characters.
